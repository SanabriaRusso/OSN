...
\emph{Author:}\\
\href{http://alejandroandr.eu}{\authornames} % Author name - remove the \href bracket to remove the link
\end{flushleft}
\end{minipage}
\begin{minipage}{0.4\textwidth}
\begin{flushright} \large
\emph{Supervisor:} \\
\href{http://jaumebarcelo.info}{\supname} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]
...
\textit{``The years teach much which the days never knew."}
...
I also strongly thank the open source community, which has been as well so motivating and helpful, and never has stopped to help. Without it, I probable could never have finished my work.

Thanks to the other fellows of BuB4EU Jorge Beltrán, Nacho Justel and Fernando Gros for accompanying me in this adventure.

Finally, my sincere gratitude as well to the European Commission through the project Commons for Europe (CIP-ICT-PSP-2011-5-297191) which was the initial seed of this project.
...
{
\textbf{ACK} & \textbf{A}\textbf{C}\textbf{K}nowledgement \\
\textbf{ADC} & \textbf{A}nalog to \textbf{D}igital \textbf{C}onverter \\
\textbf{BuB} & \textbf{B}ottom-\textbf{u}p \textbf{B}roadband \\
...
\textbf{ISM} & \textbf{I}ndustrial \textbf{S}cientific and \textbf{M}edical \\
...
\dedicatory{Dedicated to my parents, who always believed in me, and who never hesitated on answering my infancy ``\emph{why does this work?'' questions.}} % Dedication text
...
\chapter{Initial project schedule}
\includepdf[pages={-}]{Appendices/timing.pdf}
